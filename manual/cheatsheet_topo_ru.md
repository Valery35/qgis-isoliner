...
- **Overpass не резиновый.** Большие запросы серверы OSM режут, при отказе инструмент уходит на зеркало. Рамку держите скромной.
- **Замкнутые котловины.** Карст и мульды оседаний гидрокоррекция сотрёт: снимайте флажок заполнения.

\vspace{1pt}\hrule
{\footnotesize Данные: Copernicus DEM © ESA · © участники OpenStreetMap, ODbL. Плагин: plugins.qgis.org/plugins/grid\_isolines · Руководство в комплекте (doc/Isoliner.pdf) · ООО «Информ++» · www.informpp.ru}
