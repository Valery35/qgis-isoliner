...
Превращает кандидатов из 2.19 в рабочие структурные линии: снимает отметки с ЦМР, собирает формы бровка-подошва и раскладывает их по двум слоям.

| Параметр | Что задаёт | По умолчанию / совет |
|---|---|---|
| Кандидаты (выход 2.19) | Линейный слой с полем вида. | - |
