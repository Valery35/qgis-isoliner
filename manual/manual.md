...
# 2.16 Водосбор линии (канавы)

Инструмент считает площадь водосбора **линейного приёмника**: нагорной канавы, лотка, кювета дороги. Вопрос ставится так: какую площадь перехватывает канава, если самой канавы на ЦМР ещё нет.
...
| Длина трассы | trace_km | км |
| Ячеек трассы | trace_cells | шт. |
...
|---|---|---|
| Входная ЦМР | Рельеф в метрах в метрической СК. | - |
| Трассы | Линейный слой, по объекту на канаву. | - |
| Все трассы как один водосбор | Общий водосбор вместо отдельных. | выкл. |
