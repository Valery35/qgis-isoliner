...
Загвоздка в том, что у линий откоса в чертеже нет отметок. Но они есть у горизонталей, которые к этим линиям примыкают: норматив требует доводить их до линии описания объекта узловыми точками. **2.22 Отметки с примыкающих горизонталей** собирает эти точки и восстанавливает по ним профиль всей линии - переменную отметку из самих данных, а не одно число на весь объект.
