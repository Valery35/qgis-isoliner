...
- `2.21` Создать пример карьера (демо)
...
- `7.05` Создать пример для фракталов (демо)
...
Попробовать без своих данных: **1.10 Создать пример скважин (демо)** выдаёт готовый набор точек с реалистичной пространственной структурой.
...
Проверить связку целиком можно на синтетике: **2.21 Создать пример карьера (демо)** строит карьер с уступами, бермами, съездом, отвалом и канавой, а вместе с ним истинные структурные линии. Полнота детектора меряется числом против них, а не на глаз.
...
Начать проще всего с демо: **4.10 Создать пример для разреза** выдаёт шесть поверхностей, пять пластов, три линии разрезов, скважины, зоны и слои для проверки углов падения. На нём вся цепочка проходится за пять минут, и ошибиться негде.
