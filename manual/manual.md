...
![Инструменты модуля в панели «Обработка»: провайдер Isoliner с тремя группами - «1. Грид и изолинии» (1.1-1.7), «2. Дополнительные инструменты анализа» (2.1-2.6) и «3. Разрез» (3.01-3.11).](images/ui_toolbox.png){width=55%}
...
# 1.6 Создать пример скважин (демо)
