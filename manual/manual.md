...
Таблица кривой по участкам и суммарно с площадью, шириной, периметром, радиусом, скоростью и расходом на каждой отметке. Профили створов чертёжными слоями. Отчёт HTML с таблицей по каждому створу.
