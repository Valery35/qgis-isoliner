...
Инструменты **Состав пласта на разрезе** (4.03) и бета-инструменты 4.07 и 4.08 пока работают по одному разрезу и берут из определения первый. **Скважины на разрезе** (4.02) обрабатывают весь набор пакетно. При нескольких разрезах подавайте им определение, отфильтрованное на нужный створ.
