...
Поля с именами из контракта - sec, km, div_l, div_r, n_left, n_channel, n_right, slope - подхватываются без участия пользователя, подхваченные печатаются в журнал. Явный выбор всегда старше найденного.
