...
Isoliner - провайдер инструментов Processing для интерполяции точечных данных и построения изолиний. Ядро кригинга - алгоритм KB2D из GSLIB. Инструменты разнесены по двум группам: «Грид и изолинии» - семь инструментов основного потока обработки, и «Дополнительные инструменты» - четыре специализированных расчёта.
...
![Инструменты модуля в панели «Обработка»: провайдер Isoliner с двумя группами - «1. Грид и изолинии» (1.1-1.7) и «2. Дополнительные инструменты» (2.1-2.3).](images/ui_toolbox.png){width=55%}
...
| head | число | Напор (пьезометрический уровень), м. Только с галкой напора. |
