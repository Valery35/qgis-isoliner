...
- **Пологое сопряжение подошвы.** Там, где откос плавно переходит в основание, признак слаб и подошва может не найтись вовсе. Это граница метода, а не сбой: излома там физически нет.
