...
def test_divide_points_are_inserted():
    """Точка границы участка вставляется с интерполированной отметкой."""
...
def test_discharge_never_falls_with_level():
    ...
    Сторож против смещённой границы участка. Если граница уезжает с
...
def test_survey_table_carries_computation_props():
    ...
    Без границ участков, шероховатостей и уклона импорт вернул бы
...
def test_observed_levels_fall_inside_profile():
    """Учебные наблюдаемые уровни лежат в пределах профиля.
