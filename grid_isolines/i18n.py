...
TRANSLATIONS = {
    ...
    '3.1 Разрез по линии': '3.1 Cross-section along a line',
    ...
    'Готовый пример для инструментов разреза. Строит шесть гладких поверхностей, лежащих стопкой, с региональным падением и волнистой переменной мощностью. Между ними пять пластов в переслаивании: три вмещающих и два промышленных (2-й и 4-й, тонкие).\n\nПодайте шесть поверхностей сверху вниз (1...6) и линию в «Разрез по линии». Получите пять пластов на чертеже и 3D-забор. Кригинг для демо не нужен, поверхности уже растровые. Заодно выдаются скважины вдоль линии с отметками поверхностей (h1...h6) для инструмента «Скважины на разрез», а также гриды состава промышленных пластов (содержание и минтип с зоной замещения) для инструмента «Состав пласта на разрез».': 'A ready example for the section tools. It builds six smooth stacked surfaces with a regional dip and wavy variable thickness. Between them are five interbedded beds: three host beds and two industrial beds (the 2nd and 4th, thin).\n\nFeed the six surfaces top to bottom (1...6) and the line into Cross-section along a line. You get five beds on the drawing and a 3D fence. No kriging is needed for the demo, the surfaces are already rasters. It also outputs boreholes along the line with surface elevations (h1...h6) for the Boreholes on a section tool, and composition grids of the industrial beds (content and mineral type with a replacement zone) for the Bed composition on a section tool.',
    ...
    'Состав': 'Composition',
    'Состав · минтип (демо)': 'Composition · mineral type (demo)',
    'Состав · содержание (демо)': 'Composition · content (demo)',
    ...
    'Состав: минтип/фации (1 сильвинит, 2 замещение)': 'Composition: mineral type/facies (1 sylvinite, 2 replacement)',
    'Состав: содержание (для промышленных пластов)': 'Composition: content (for the industrial beds)',
    'зоны': 'zones',
    ...
    '3.4 Пересечение поверхностей с разрезом': '3.4 Intersect surfaces with the section',
    ...
    'Число отметок высоты на осях': 'Number of elevation ticks on the axes',
    ...
    '3.2 Скважины на разрезе': '3.2 Boreholes on the section',
    '3.3 Состав пласта на разрезе': '3.3 Bed composition on the section',
