...
на малых шагах даёт H, а фрактальная размерность D = 3 - H лежит в
...
def _lag_stats(z, valid, h):
    """Суммы квадратов разностей и счётчики пар для шага h по X и Y,
...
def fractal_dimension_map(z, window=8, max_lag=4, min_pairs=32):
    ...
    max_lag - число шагов 1..max_lag (шаг один это соседние ячейки); min_pairs - минимум пар на шаг.
